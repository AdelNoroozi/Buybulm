...
class Payment(models.Model):
    ...
    receipt = models.FileField(verbose_name=_('receipt'), upload_to='payments/', blank=True, null=True)
    ...
    status = models.CharField(max_length=20, choices=STATUSES, verbose_name=_('status'))
